...
html_theme_options = {
    ...
    "features": [
        ...
        "navigation.top",  # back-to-top button can be shown when the user, after scrolling down, starts to scroll up again. It's rendered centered and just below the header; not yet available.
        ...
        "search.highlight",  # a user clicks on a search result, Material for MkDocs will highlight all occurrences after following the link
